...
<body>
    ...
    <main>
        ...
        <nav class="nav bg-light justify-content-center">
            <a href="acceuil.php" class=" lien nav-link text-dark">Nos service</a>
            <a href="vehicule.php" class="lien nav-link text-dark">nos véhicules</a>
        </nav>
        <article>
        ...
        <article>
            <div class="col-md-12 col-sm-12">
                <div class="card mb-4 shadow-sm">
                  ...
                  <?php  // Requête SQL pour récupérer les commentaires validés
$sql = "SELECT nom_prenom, commentaire, note FROM comments WHERE online = 1";
$result = $conn->query($sql);

// Vérifier s'il y a des commentaires validés
if ($result->rowCount() > 0) {
    ...
    echo "Aucun commentaire validé trouvé.";
}
